...
Это ещё не process_post (часть 2 этапа 14). process_post вызовет тот же
порядок. Здесь — функция-сборка assemble_post, чтобы 14B и 14A можно
было проверить вместе.
...
def assemble_post(
    ...
    *,
    ...
    """Сборка шага 0…7 без единого вида и без process_post.
